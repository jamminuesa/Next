 ...
 * [SaltaConejoApplication].
 */
fun CreationExtras.saltaConejoApplication(): SaltaConejoApplication =
    (this[AndroidViewModelFactory.APPLICATION_KEY] as SaltaConejoApplication)
