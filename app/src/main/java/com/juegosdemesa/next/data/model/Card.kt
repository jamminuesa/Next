...
data class Card(
    ...
    enum class Category(
        ...
        DEFAULT(0, "", "", ""),
        COUNTRY(1, "País",  "Describe: Españita",
        ...
        PEOPLE(2, "Personajes",  "Describe: Personas y personajes",
        ...
        BRANDS(3, "Marcas",  "Describe: Marcas",
        ...
        SPORTS(4, "Deportes",  "Mímica: Deporte",
        ...
        HUM(8, "Tararear",  "Sonido: Tararea las canciones",
        ...
        FINISH_THE_SONG(9, "Termina la canción",  "Termina la canción",
